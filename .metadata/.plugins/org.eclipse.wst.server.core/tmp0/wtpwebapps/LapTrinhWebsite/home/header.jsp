...
<body class="">
	<div class="container-fluid" style="padding: 0;">
		<nav class="navbar navbar-expand-lg navbar-light bg-light" id="nav">
			<div class="container">
				<a class="navbar-brand" href="trang-chu"> <img src="home/image/logo.png"
					alt="" style="width: 120px; height: 60px">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item text-uppercase font-weight-bold li-item">
							<a class="nav-link a-item" href="trang-chu">TRANG CHỦ</a>
						</li>
						<li class="nav-item text-uppercase font-weight-bold li-item">
							<a class="nav-link a-item" href="danh-sach-san-pham?type=shoes">GIÀY</a>
						</li>
						<li class="nav-item text-uppercase font-weight-bold li-item">
